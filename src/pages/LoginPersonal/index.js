...
const Personal = () => {
    ...
    const Login = async () => {
        try {
            ...
            const response = await api.post('/personal/login', credenciais);
            ...
            localStorage.setItem('@personal', JSON.stringify(res.personal))
    ...
    return (
        <div className="bg-black flex">
            <div className="flex-col flex ml-auto mr-auto items-center w-full h-full lg:w-2/3 md:w-3/5 mt-20 pb-20">
                <h1 className="font-bold text-2xl my-10 text-white"> Acesso Personal</h1>
