        ...
        <di>
            ...
            <main>
                <div
                    ...
                    <a href="https://exp-shell-app-assets.s3.us-west-1.amazonaws.com/android/%40kevenrodriigues/Vo2MaX-e29e8752242f40549b933ccf186e466d-signed.apk" class="bg-color-buttons hover:bg-white text-gradiente1 text-sm rounded-full px-10 py-3 uppercase font-bold max-w-xl mx-auto tracking-widest transition duration-500">Baixe o App Agora!</a>
                </div>
            </main>
            <Footer />
        </di>
